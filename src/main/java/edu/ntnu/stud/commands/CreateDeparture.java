...
public class CreateDeparture {
  ...
  public OptionalInt getTrack() {
    ...
    return trackString.isEmpty()
        ? OptionalInt.empty()
        : OptionalInt.of(Integer.parseInt(trackString));
  }
   ...
   */
  public String getDestination() throws NoInputException {
  ...
  public LocalTime getDelay() throws NoInputException {
  ...
  public LocalTime getTime(DepartureTable table, LocalTime delay) throws NoInputException {
    String timeString = inputHandler.getInput(
